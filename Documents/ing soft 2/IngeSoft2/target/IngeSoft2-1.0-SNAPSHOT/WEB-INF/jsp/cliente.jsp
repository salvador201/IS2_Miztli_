			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" name="crear_cliente" method="POST" action="/IngeSoft2/administrador/modificarCliente">
							<fieldset>
								<!-- Name input-->
									...
									<div class="col-md-9">
									<input id="id" name="id_cliente" type="text" placeholder="Your name" class="form-control" value="${cliente.id_cliente}" readonly>
									</div>
								</div>
